...
$PLIST -c "Set :CFBundleVersion ${buildNumber}" ${TARGET_BUILD_DIR}/${TARGETNAME}.app/Contents/Info.plist
...
echo -e "$PLIST -c \"Set :BuildRevision ${buildRevision}\" ${TARGET_BUILD_DIR}/${TARGETNAME}.app/Contents/Info.plist"
#pwd

$PLIST -c "Set :BuildRevision ${buildRevision}" ${TARGET_BUILD_DIR}/${TARGETNAME}.app/Contents/Info.plist
